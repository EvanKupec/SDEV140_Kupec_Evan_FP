...
class left_side_scrl:
    def __init__(self, root):
        ...
        self.invisible_frame = ctk.CTkFrame(self.root, width=500, height=1)
        self.invisible_frame.pack(side=tk.TOP, fill=tk.BOTH, padx=1, pady=1)

        # Button to create nested frame
        self.create_frame_button = tk.Button(self.root, text="Add Item", command=self.ask_for_item_number)
        self.create_frame_button.pack(side=tk.RIGHT, padx=10, pady=5)
        ...
        self.total_label.pack(side=tk.BOTTOM, anchor=tk.W)
